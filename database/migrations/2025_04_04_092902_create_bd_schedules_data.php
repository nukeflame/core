...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('bd_schedule_template_data', function (Blueprint $table) {
            $table->string('clause_id',20)->nullable(false)->primary();;
            $table->string('class_code',20)->nullable(false);
            $table->string('type_of_bus',20)->nullable(false);
            $table->string('class_group_code',20)->nullable(false);

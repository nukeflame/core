...
Route::group(['prefix' => 'cover', 'middleware' => ['auth', 'passexpiry']], function () {
    ...
    Route::get('/classGroup', [SettingsCoverController::class, 'ClassGroupInfo'])->name('classGroup.info');
    ...
    Route::get('/class', [SettingsCoverController::class, 'ClassInfo'])->name('class.info');
    ...
    Route::get('/customerType', [SettingsCoverController::class, 'CustomerTypeInfo'])->name('customerType.info');
    ...
    Route::get('/country', [SettingsCoverController::class, 'CountryInfo'])->name('country.info');
    ...
    Route::get('/businessType', [SettingsCoverController::class, 'BusinessTypeInfo'])->name('businessType.info');
    ...
    Route::get('/payMethod', [SettingsCoverController::class, 'PayMethodInfo'])->name('payMethod.info');
    ...
    Route::get('/sumInsType', [SettingsCoverController::class, 'SumInsTypeInfo'])->name('sumInsType.info');
    ...
    Route::get('/reinsDivision', [SettingsCoverController::class, 'ReinsDivisionInfo'])->name('reinsDivision.info');
    ...
    Route::get('/reinsClass', [SettingsCoverController::class, 'ReinsClassInfo'])->name('reinsClass.info');
    ...
    Route::get('/reinsClassPremtypes', [SettingsCoverController::class, 'reinsClassPremtypesInfo'])->name('reinsClassPremtypes.info');
    ...
    Route::get('/treatyType', [SettingsCoverController::class, 'treatyTypeInfo'])->name('treatyType.info');

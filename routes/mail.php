...
Route::group(
    ...
    function () {
        ...
        // Route::get('/folder/{folder}', [EmailController::class, 'folder'])->name('folder');
        // Route::get('/email/{id}', [EmailController::class, 'show'])->name('show');
        // Route::post('/send', [EmailController::class, 'send'])->name('send');
        // Route::post('/reply/{id}', [EmailController::class, 'reply'])->name('reply');

        // Route::post('/outlook/connect', [OutlookController::class, 'connect'])->name('outlook.connect');

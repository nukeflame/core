...
class CoverRegistrationRequest extends FormRequest
{
    ...
    protected function getTreatyProportionalRules(): array
    {
        return [
            ...
            'prem_tax_rate' => 'nullable|numeric|min:0|max:100',
            'ri_tax_rate' => 'nullable|numeric|min:0|max:100',
            'treaty_brokerage_comm_rate' => 'required|numeric|min:0|max:100',
            'port_prem_rate' => 'nullable|numeric|min:0|max:100',
            'port_loss_rate' => 'nullable|numeric|min:0|max:100',
            'profit_comm_rate' => 'nullable|numeric|min:0|max:100',
            'mgnt_exp_rate' => 'nullable|numeric|min:0|max:100',
            'deficit_yrs' => 'nullable|integer|min:0|max:10',
            'treaty_reinclass' => 'required|array|min:1',
            'treaty_reinclass.*' => 'required',
            ...
            'cashloss_limit' => 'nullable|array',
            'cashloss_limit.*' => 'nullable|string',
            'prem_type_code' => 'required|array|min:1',
            'prem_type_code.*' => 'required|string',
            'prem_type_reinclass' => 'nullable|array',
            'prem_type_treaty' => 'nullable|array',
            'flat_prem_type_comm_rate' => 'nullable|array',

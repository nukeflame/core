...
@section('content')
    ...
    <div class="cover-wrapper form-group">
        <form id="register_cover"
            action="@if ($trans_type == 'NEW') {{ route('cover.register') }} @else {{ route('cover.editCoverRegister') }} @endif"
            method="POST">
            {{ csrf_field() }}
            ...
            <div class="form-group" id="fac_section">
                <div class="row row-cols-12">
                    ...
                    <div class="col-sm-3 fac_section_div">
                        ...
                        <div class="cover-card">
                            <select class="form-inputs section select2 fac_section" name="insured_name" id="insured_name"
                                required>
                                @if ($trans_type == 'NEW')
                                    <option selected value="">Choose Insured</option>
                                    @foreach ($insured as $insured_names)
                                        <option value="{{ $insured_names->name }}">{{ $insured_names->name }}</option>
                                    @endforeach
                                @elseif(
                                    $trans_type == 'REN' ||
                                        $trans_type == 'EDIT' ||
                                    ...
                                    @foreach ($insured as $insured_names)
                                        <option value="{{ $insured_names->name }}"
                                            @if ($old_endt_trans->insured_name == '{{ $insured_names->name }}') selected @endif>{{ $insured_names->name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                ...
                <div class="row row-cols-12">
                    ...
                    <div class="col-sm-3">
                        ...
                        @else
                            <textarea class="form-inputs section fac_section resize-none" id="risk_details" name="risk_details" required> {{ $old_endt_trans->risk_details }} </textarea>
                        @endif
                    </div>
                    <div class="col-xl-3 fac_section_div">
                    ...
                    <div class="col-xl-3 fac_section_div">
                        ...
                        @if ($trans_type == 'NEW')
                            <input type="number" class="form-inputs fac_section" aria-label="fac_share_offered"
                                id="fac_share_offered" name="fac_share_offered" max="100" min="0" required>
                        @else
                            <input type="number" class="form-inputs fac_section" aria-label="fac_share_offered"
                                id="fac_share_offered" name="fac_share_offered" max="100" min="0"
                                value="{{ $old_endt_trans->share_offered }}" required>
                        @endif
                    </div>
                </div>
                ...
                <div class="row row-cols-12">
                    <div class="col-xl-3 fac_section_div">
                        ...
                        @if ($trans_type == 'NEW')
                            <input type="text" class="form-inputs fac_section" aria-label="comm_rate" id="comm_rate"
                                name="comm_rate" required>
                        @else
                            <input type="text" class="form-inputs fac_section" aria-label="comm_rate" id="comm_rate"
                                name="comm_rate" value="{{ $old_endt_trans->cedant_comm_rate }}" required>
                        @endif
                    </div>
                    <div class="col-xl-3 fac_section_div">
                        ...
                        @if ($trans_type == 'NEW')
                            <input type="text" class="form-inputs fac_section" aria-label="comm_amt" id="comm_amt"
                                name="comm_amt" onkeyup="this.value=numberWithCommas(this.value)" required>
                        @else
                            <input type="text" class="form-inputs fac_section" aria-label="comm_amt" id="comm_amt"
                                name="comm_amt" value="{{ number_format($old_endt_trans->cedant_comm_amount, 2) }}"
                                onkeyup="this.value=numberWithCommas(this.value)" required>
                        @endif
                    </div>
                    <div class="col-xl-3 fac_section_div reins_comm_type_div">
                        ...
                        <div class="cover-card">
                            <select class="form-inputs section select2 fac_section reins_comm_type" name="reins_comm_type"
                                ...
                                @if ($trans_type == 'NEW' || $trans_type == 'REN')
                                ...
                                @else
                                    ...
                                    <option value="A" @if ($old_endt_trans->rein_comm_type == 'A') selected @endif>Amount
                                    </option>
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="col-xl-3  fac_section_div reins_comm_rate_div">
                        ...
                        @else
                            <input type="text" class="form-inputs fac_section reins_comm_rate"
                                aria-label="reins_comm_rate" id="reins_comm_rate" name="reins_comm_rate"
                                value="{{ $old_endt_trans->rein_comm_rate }}" required disabled>
                        @endif
                    </div>
                    <div class="col-xl-3 fac_section_div reins_comm_amt_div">
                        ...
                        @else
                            <input type="text" class="form-inputs fac_section reins_comm_amt"
                                aria-label="reins_comm_amt" id="reins_comm_amt" name="reins_comm_amt"
                                value="{{ $old_endt_trans->rein_comm_amount }}"
                                onkeyup="this.value=numberWithCommas(this.value)"
                                onchange="this.value=numberWithCommas(this.value)" required>
                        @endif
                    </div>
                        ...
                        <div class="cover-card">
                            @if ($trans_type == 'NEW')
                                <select name="brokerage_comm_type" id="brokerage_comm_type"
                                    ...
                                    <option value="R">Rate (<small><i>reinsurer rate - cedant rate</i></small>)
                                    </option>
                                    <option value="A">Quoted Amount</option>
                                </select>
                            @else
                                <select name="brokerage_comm_type" id="brokerage_comm_type"
                                    class="form-inputs section select2" required>
                                    <option value="" @if ($old_endt_trans->brokerage_comm_type == '') selected @endif>
                                        --Select
                                        basis--</option>
                                    <option value="R" @if ($old_endt_trans->brokerage_comm_type == 'R') selected @endif>Rate
                                        (<small><i>reinsurer rate - cedant rate)</option>
                                    <option value="A" @if ($old_endt_trans->brokerage_comm_type == 'A') selected @endif> Quoted
                                        Amount</option>
                                </select>
                            @endif
                        </div>
                    ...
                    <div class="col-xl-3 fac_section_div brokerage_comm_amt_div">
                        ...
                        @if ($trans_type == 'NEW')
                            <input type="text" class="form-inputs fac_section amount" id="brokerage_comm_amt"
                                name="brokerage_comm_amt" value="0">
                        @else
                            <input type="text" class="form-inputs fac_section amount" id="brokerage_comm_amt"
                                name="brokerage_comm_amt" value="{{ $old_endt_trans->brokerage_comm_amt }}">
                        @endif
                    </div>
                    <div class="col-xl-3 fac_section_div brokerage_comm_rate_div">
                        ...
                        @if ($trans_type == 'NEW')
                            <input type="text" class="form-inputs fac_section amount" id="brokerage_comm_rate"
                                name="brokerage_comm_rate" value="">
                        @else
                            <input type="text" class="form-inputs fac_section amount" id="brokerage_comm_rate"
                                name="brokerage_comm_rate" value="{{ $old_endt_trans->brokerage_comm_rate }}">
                        @endif
                    </div>
                            ...
                            <select class="form-inputs section treatytype trt_common" name="treatytype" id="treatytype"
                                ...
                                @elseif(
                                    ...
                                    @foreach ($treatytypes as $treatytype)
                                        @if ($treatytype->treaty_code == $old_endt_trans->treaty_code)
            ...
            <div class="row mb-3">
                <div class="col-sm-3">
                    @switch($trans_type)
                        @case('NEW')
                            <button type="button" id="save_cover"
                                class="btn btn-dark btn-raised-shadow btn-sm btn-wave">Save</button>
                        @break
                        ...
                        @case('RFN')
                        @case('INS')
                            <button type="submit" id="ext_cover"
                                class="btn btn-dark btn-raised-shadow btn-sm btn-wave">Save</button>
                        @break

                        @case('REN')
                            <button type="submit" id="renew_cover"
                                class="btn btn-dark btn-raised-shadow btn-sm btn-wave">Renew</button>
                        @break
                    @endswitch
                </div>
            </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            // Add change event listener to both input fields
            ...
            function checkDateValidity() {
                ...
                // Check if cover_from is greater than or equal to cover_to
                if (coverFromDate >= coverToDate) {
                    ...
                    // Reset the value of cover to input to null

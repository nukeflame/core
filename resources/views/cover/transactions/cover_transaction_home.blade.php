...
@section('content')
    ...
    @php
        ...
        $debits = [
            (object) [
                'id' => 1,
                'debit_note_number' => 'TRN-2024-00001',
            ...
            (object) [
                'id' => 2,
                'debit_note_number' => 'TRN-2024-00002',
                'debit_date' => '2024-01-15',
    ...
    <div class="row row-cols-12 mx-0">
        @if ($actionable)
            <x-cover.action-card :cover="$cover" :endorsementNarration="$endorsementNarration" :isTransaction="$isTransaction" />
        @endif

        <x-cover.summary-card :cover="$cover" :customer="$customer" :title="'Policy Transaction Details'" :transactionInfo="true" />
    </div>
    ...
    <div class="info-card">
        <ul class="nav nav-tabs custom-tabs" id="transactionTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="debits-tab" data-bs-toggle="tab" data-bs-target="#debits" type="button"
                    role="tab">
                    <i class="bi bi-cash-stack"></i> Debits (2)
                </button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="transactionTabsContent">
            ...
            <!-- Debits Tab -->
            <div class="tab-pane fade show" id="debits" role="tabpanel">
                ...
                <table class="table table-hover data-table">
                    ...
                    <tbody>
                        @foreach (array_slice($debits, 0, 2) as $debit)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-primary btn-table-action"
                                        onclick="window.location.href='{{ url('cover/treaty/' . $cover->endorsement_no . '/transactions/' . $debit->debit_note_number . '/debit') }}'">
                    ...
                    <tbody>
                        @foreach (array_slice($commissionAdjustments, 0, 10) as $adj)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-primary btn-table-action"
                                        onclick="window.location.href='{{ url('cover/treaty/' . $cover->endorsement_no . '/transactions/' . $adj->reference_number . '/debit') }}'">
                                        <i class="bi bi-eye"></i> View
                                    </button>
                                </td>
                            </tr>

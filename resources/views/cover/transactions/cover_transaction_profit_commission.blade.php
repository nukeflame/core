...
@section('content')
    @php
        ...
        $profitCommissions = $profitCommissions ?? collect();
        ...
        $totalProfitCommission = $profitCommissions->sum('foreign_nett_amount');
    ...
    {{-- <div class="financial-grid">
        ...
        <div class="financial-card adjustments">
            <div class="financial-label">Total Profit Commission</div>
    ...
    <div class="summary-card mb-4">
        <div class="summary-grid">
            <div class="summary-item">
                ...
                <span class="summary-value highlight">{{ $entryTypeDisplay }}</span>
            </div>
            <div class="summary-item">

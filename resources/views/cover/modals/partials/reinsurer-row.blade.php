...
<div id="{{ $rowId }}" data-treaty-counter="{{ $treatyCounterValue }}" data-counter="{{ $counterValue }}"
    ...
    @if (!$isTemplate && $counter > 0)
        <button type="button"
            ...
            data-treaty-counter="{{ $treatyCounter }}" data-counter="{{ $counter }}">
            <i class="fas fa-trash"></i>
        </button>
    @endif

    <h6 class="mb-3 text-primary fs-14">
        <i class="bx bx-building me-1"></i>Reinsurer #<span class="reinsurer-number">{{ $reinsurerNumber }}</span>
    </h6>
    ...
    @if (in_array($cover->type_of_bus, ['FPR', 'FNP']))
        <div class="row mt-3">
            <div class="col-md-3">
                ...
                <input type="text"
                    ...
                    class="form-control reinsurer-sum-insured reinsurers color-blk"
            ...
            <div class="col-md-3">
                ...
                <input type="text"
                    ...
                    class="form-control reinsurer-comm-amt reinsurers color-blk"
                    data-treaty-counter="{{ $treatyCounterValue }}" data-counter="{{ $counterValue }}" readonly />
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 fac_section_div brokerage_comm_rate_div">
                ...
                <input type="text" class="form-control color-blk reinsurers brokerage-comm-rate-amnt"
        ...
        <div class="row mt-3">
            <div class="col-md-3">
                <label for="reinsurer-apply_fronting-{{ $treatyCounterValue }}-{{ $counterValue }}"
                    class="form-label">
                    Apply Retro Fee
                </label>
                <div class="reinsurer-card">
            ...
            <div class="col-md-3 fronting_div"
                ...
                <input class="form-control reinsurer-fronting-amt reinsurers"
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-3 no-of-installments-section" style="display: none">
            ...
            <input type="number" min="1" max="12" class="form-control no-of-installments reinsurers"
        ...
        <div class="col-md-3 add-installment-btn-section" style="display: none">
            ...
            <button type="button" class="btn btn-primary btn-sm d-block add-reinsurer-installments"
                data-treaty-counter="{{ $treatyCounterValue }}" data-counter="{{ $counterValue }}">
                <i class="fas fa-calendar-plus me-1"></i> Generate Installments
            </button>
        </div>
    </div>

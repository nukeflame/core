<div class="modal fade effect-scale md-wrapper" id="treatyCreditModal" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticCreditLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" style="max-width: 75%;">
        <div class="modal-content">
            <form method="POST" id="treatyCreditForm" action="{{ route('cover.generate-credit') }}">
                @csrf
                ...
                <input type="hidden" name="creditClasses" value="{{ json_encode($treatyClasses) }}"
                    id="creditClasses" />

                <div class="modal-header bg-success-gradient">
                    <h5 class="modal-title text-white" id="staticCreditLabel">Generate Credit Note</h5>
                ...
                <div class="modal-body">
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow-sm mb-3">
                                <div class="card-header bg-light py-2">
                                    <h6 class="mb-0 fw-semibold">Credit Information</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <label class="form-label" for="credit_posting_year">
                                                Underwriting Year <span class="text-danger">*</span>
                                            </label>
                                            <select name="posting_year" id="credit_posting_year" class="form-select" required>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label" for="credit_posting_quarter">
                                                Posting Quarter <span class="text-danger">*</span>
                                            </label>
                                            <select name="posting_quarter" id="credit_posting_quarter" class="form-select"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label" for="credit_posting_date">
                                                Posting Date <span class="text-danger">*</span>
                                            </label>
                                            <input type="date" name="posting_date" id="credit_posting_date"
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label" for="credit_brokerage_rate">Brokerage Rate (%)</label>
                                            <input type="number" name="brokerage_rate" id="credit_brokerage_rate"
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label" for="credit_premium_levy">Premium Levy (%)</label>
                                            <input type="number" name="premium_levy" id="credit_premium_levy"
                                                class="form-control" step="0.01" value="1" min="0"
                                                max="100" />
                                        </div>

                                        <div class="col-md-3">
                                            <label class="form-label" for="credit_reinsurance_levy">Reinsurance Levy
                                                (%)</label>
                                            <input type="number" name="reinsurance_levy" id="credit_reinsurance_levy"
                                                class="form-control" step="0.01" value="0" min="0"
                                                max="100" />
                                        </div>

                                        <div class="col-md-3">
                                            <label for="credit_wht_rate" class="form-label">
                                                WHT Rate (%)
                                            </label>
                                            <div>
                                                <div class="cover-card">
                                                    <select name="wht_rate" id="credit_wht_rate" class="select2">
                                                        <option value="">
                                                            --Select WHT--</option>
                    ...
                    <div class="row mb-3">
                        <div class="col-12 mb-2">
                            <label class="form-label" for="credit_comments">Comments</label>
                            <textarea name="comments" id="credit_comments" class="form-control resize-none" rows="3"
                                placeholder="Enter any additional information or remarks" maxlength="2000"></textarea>
                            <small class="text-muted">
                                <span id="credit-comments-count">0</span>/2000 characters
                            </small>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="show_cedant"
                                            id="credit_show_cedant" value="1">
                                        <label class="form-check-label" for="credit_show_cedant">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="show_reinsurer"
                                            id="credit_show_reinsurer" value="1">
                                        <label class="form-check-label" for="credit_show_reinsurer">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header py-2 d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-success" id="add-credit-item">
                                        <i class="fas fa-plus me-1"></i> Add Line Item
                                    </button>
                                </div>
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-sm table-hover mb-0" id="credit-items-table">
                                            ...
                                            <tfoot class="table-light">
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-success">
                                                        <span id="credit-total-amount">0.00</span>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            </tfoot>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="credit-save-btn" class="btn btn-success btn-sm">
                        <i class="fas fa-check me-1"></i> Generate Credit Note
                    </button>
                </div>
            </form>
        </div>
...
{{-- Item Row Template --}}
<template id="credit-item-row-template">
    <tr class="credit-item-row" data-item-index="INDEX">
        <input type="hidden" class="item-type" name="items[INDEX][item_type]" value="CREDIT" />
        ...
        <td>
            <input type="number" name="items[INDEX][line_rate]"
                ...
                min="0" max="100" value="0" required title="Commission rate is required (0-100%)" />
        </td>
        <td>
        ...
        <td class="text-center">
            <button type="button" class="btn btn-sm btn-outline-danger remove-credit-item-btn" title="Remove item">
...
<style>
    #treatyCreditModal .modal-body {
        max-height: 75vh;
        overflow-y: auto;
    }

    #treatyCreditModal .form-label {
        margin-bottom: 0.25rem;
        font-weight: 500;
        font-size: 0.875rem;
    }

    #treatyCreditModal .card {
        border: 1px solid #dee2e6;
        border-radius: 0.375rem;
    }

    #treatyCreditModal .card-header {
        background-color: #f8f9fa;
        border-bottom: 1px solid #dee2e6;
    }

    #treatyCreditModal .form-check-input:checked {
        background-color: #198754;
        border-color: #198754;
    }

    #treatyCreditModal .table th {
        font-weight: 600;
        font-size: 0.813rem;
        background-color: #f8f9fa;
    }

    #treatyCreditModal .table-responsive {
        max-height: 400px;
        overflow-y: auto;
    }

    #treatyCreditModal .resize-none {
        resize: none;
    }

    #treatyCreditModal .credit-item-row {
        transition: background-color 0.2s ease;
        background-color: #d1e7dd;
    }

    #treatyCreditModal .credit-item-row:hover {
        background-color: #c3dcd2;
    }

    #treatyCreditModal .error-field {
        border-color: #dc3545 !important;
    }

    #treatyCreditModal .error-message {
        color: #dc3545;
        font-size: 0.75rem;
        margin-top: 0.25rem;
        display: block;
    ...
    #treatyCreditModal .table-responsive::-webkit-scrollbar {
        width: 8px;
        height: 8px;
    }

    #treatyCreditModal .table-responsive::-webkit-scrollbar-track {
        background: #f1f1f1;
    }

    #treatyCreditModal .table-responsive::-webkit-scrollbar-thumb {
        background: #888;
        border-radius: 4px;
    }

    #treatyCreditModal .table-responsive::-webkit-scrollbar-thumb:hover {
        background: #555;
    }

    #treatyCreditModal .bg-success-gradient {
...
@push('script')
    <script>
        (function($) {
            ...
            const TreatyCreditModal = {
                config: {
                    selectors: {
                        modal: '#treatyCreditModal',
                        form: '#treatyCreditForm',
                        itemsBody: '#credit-items-body',
                        template: '#credit-item-row-template',
                        addBtn: '#add-credit-item',
                        saveBtn: '#credit-save-btn',
                        totalAmount: '#credit-total-amount',
                        noItemsRow: '#no-credit-items-row',
                        commentsField: '#credit_comments',
                        commentsCount: '#credit-comments-count',
                        postingYear: '#credit_posting_year',
                        postingQuarter: '#credit_posting_quarter',
                        postingDate: '#credit_posting_date',
                        brokerageRate: '#credit_brokerage_rate',
                        creditClasses: "#creditClasses"
                    },
                    classes: {
                        itemRow: '.credit-item-row',
                        removeBtn: '.remove-credit-item-btn',
                ...
                bindEvents: function() {
                    ...
                    this.$el.brokerageRate.on('input change', function() {
                        self.debouncedCalculate();
                    });
                ...
                filterBusinessClasses: function($classType) {
                    ...
                    const creditClasses = $(this.config.selectors.creditClasses).val();
                    ...
                    // For credit notes, commission rate is typically 0
                    $commRate.val('0');
                },
                ...
                calculateTotals: function() {
                    ...
                    this.$el.totalAmount.text(this.formatCurrency(totalAmount));
                },
                ...
                validateLineItems: function() {
                    ...
                    $rows.each(function(index) {
                        ...
                        if (commissionRateValue === '' || commissionRateValue === null) {
                ...
                handleSuccess: function(response) {
                    if (response.success) {
                        this.notify(response.message || 'Credit note generated successfully', 'success');
                        if (response.redirect_url || response.redirectUrl) {
                            const url = response.redirect_url || response.redirectUrl;
                            setTimeout(function() {
                                window.location.href = url;
                            }, 800);
                        } else if (response.credit_note_id) {
            ...
            $(function() {
                TreatyCreditModal.init();
            });

            window.TreatyCreditModal = TreatyCreditModal;
        })(jQuery);
    </script>
@endpush

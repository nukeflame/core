            ...
            <div class="col-md-12 ">
                <div class="card px-0 pt-4 pb-0 mb-3">
                                                ...
                                                <x-SearchableSelect name="lead_year" id="lead_year" req="required"
                                                    ...
                                                    @foreach ($pipeYear as $year)
                                                        <option value="{{ $year->id }}"
                                                            {{ isset($prospProperties->pip_year) && (int) old('pip_year', $prospProperties->pip_year) === (int) $year->id ? 'selected' : '' }}>
                                                            {{ $year->year }}
                                                        </option>
                                                    @endforeach
                                                </x-SearchableSelect>
                                            ...
                                            <div id="trt_common">
                                                <div class="row row-cols-12">
                                                    ...
                                                    <div class="col-sm-3 date_offered_div trt_common_div">
                                                        ...
                                                        @else
                                                            <input type="date"
                                                                class="form-inputs date_offered trt_common"
                                                                value="{{ $prospProperties->tr_date_offered }}"
                                                                aria-label="date_offered" id="date_offered"
                                                                name="date_offered" required>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3 trt_common_div">
                                                        ...
                                                        <input type="date" class="form-inputs trt_common"
                                                            id="expected_closure_date" name="expected_closure_date"
                                                            value="{{ old('expected_closure_date', $prospProperties->expected_closure_date) }}"
                                                            required />
                                                    </div>

                                                    <div class="col-sm-3 trt_common">
                                                    ...
                                                    <div class="col-sm-2 share_offered_div trt_common_div">
                                                        ...
                                                        <input type="text" class="form-inputs share_offered trt_common"
                                                            @if ($trans_type != 'NEW') value="{{ number_format($prospProperties->fac_share_offered, 2) }} @endif"
                                                    ...
                                                    <div class="col-sm-2 prem_tax_rate_div trt_common_div">
                                                        ...
                                                        <input type="number" class="form-inputs prem_tax_rate trt_common"
                                                            value="{{ number_format($prospProperties->prem_tax_rate, 2) }}"
                                                    ...
                                                    <div class="col-sm-2 ri_tax_rate_div prem_tax_rate_div trt_common_div">
                                                        ...
                                                        <input type="number" class="form-inputs ri_tax_rate trt_common"
                                                            value="{{ number_format($prospProperties->ri_tax_rate, 2) }}"
                                                    ...
                                                    <div class="col-sm-2 ">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            @if ($trans_type != 'NEW') value="{{ isset($prospProperties->brokerage_comm_rate) ? number_format((float) $prospProperties->brokerage_comm_rate, 2) : '0.00' }}" @endif
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2 reinsurer_per_treaty_div tpr_section_div">
                                                        <label class="required ">Reinsurers are captured per treat
                                                            ?</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 port_prem_rate_div tpr_section_div">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                min="0" required
                                                                @if ($trans_type != 'NEW') value="{{ isset($coverreinprops[0]->port_prem_rate) ? number_format((float) $coverreinprops[0]->port_prem_rate, 2) : '0.00' }}" @endif>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-3 port_loss_rate_div tpr_section_div">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                min="0" required
                                                                @if ($trans_type != 'NEW') value="{{ isset($coverreinprops[0]->port_loss_rate) ? number_format((float) $coverreinprops[0]->port_loss_rate, 2) : '0.00' }}" @endif>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-3 profit_comm_rate_div tpr_section_div">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                min="0" required
                                                                @if ($trans_type != 'NEW') value="{{ isset($coverreinprops[0]->profit_comm_rate) ? number_format((float) $coverreinprops[0]->profit_comm_rate, 2) : '0.00' }}" @endif>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-3 mgnt_exp_rate_div tpr_section_div">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                min="0" required
                                                                @if ($trans_type != 'NEW') value="{{ isset($coverreinprops[0]->mgnt_exp_rate) ? number_format((int) $coverreinprops[0]->mgnt_exp_rate, 2) : '0.00' }}" @endif>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 deficit_yrs_div tpr_section_div">
                                                            ...
                                                            <input type="number" class="form-inputs  tpr_section"
                                                                ...
                                                                max="10" required
                                                                @if ($trans_type != 'NEW') value="{{ isset($coverreinprops[0]->deficit_yrs) ? $coverreinprops[0]->deficit_yrs : '0.00' }}" @endif>
                                                        </div>
                                                                    ...
                                                                    <select
                                                                        ...
                                                                        @elseif(
                                                                            $trans_type == 'EXT' ||
                                                                                ...
                                                                                $trans_type == 'EDIT')
                                                                            @foreach ($reinsclasses as $reinsclass)
                                                                                @if ($reinsclass->class_code == $coverreinprops->reinsclass)
                                                                                    <option
                                                                                        value="{{ $reinsclass->class_code }}"
                                                                                        selected>
                                                                                        {{ $reinsclass->class_name }}
                                                        ...
                                                        @foreach ($coverreinpropClasses as $index => $coverreinpropCls)
                                                            <div class="row reinclass-section "
                                                                ...
                                                                @php
                                                                    ...
                                                                    $quotaCoverreinprop = $coverreinprops
                                                                        ->where(
                                                                            'reinclass',
                                                                    ...
                                                                    $surpCoverreinprop = $coverreinprops
                                                                        ->where(
                                                                            'reinclass',
                                                                            $coverreinpropCls->reinclass,
                                                                        )
                                                                ...
                                                                <div class="row quota_header_div tpr_section_div"
                                                                    style="display: none"
                                                                    @if (isset($surpCoverreinprop)) hidden @endif>
                                                                    <h6> Quota Share </h6>
                                                                </div>
                                                                <div class="row">
                                                                    <!--quota limit-->
                                                                    <div class="col-sm-2 quota_share_total_limit_div tpr_section_div"
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            name="quota_share_total_limit[]"
                                                                            onkeyup="this.value=numberWithCommas(this.value)"
                                                                            value="{{ isset($quotaCoverreinprop) ? number_format((int) $quotaCoverreinprop->treaty_limit, 2) : '' }}"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-1 retention_per_div tpr_section_div"
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            max="100"
                                                                            value="{{ isset($quotaCoverreinprop) ? number_format((int) $quotaCoverreinprop->retention_rate, 2) : '' }}"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-3 quota_retention_amt_div tpr_section_div"
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            onkeyup="this.value=numberWithCommas(this.value)"
                                                                            value="{{ isset($quotaCoverreinprop) ? number_format((int) $quotaCoverreinprop->retention_amount, 2) : '' }}"
                                                                            required disabled>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-2 treaty_reice_div tpr_section_div"
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            min="0" max="100"
                                                                            value="{{ isset($quotaCoverreinprop) ? number_format((int) $quotaCoverreinprop->treaty_rate, 2) : '' }}"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-3 quota_treaty_limit_div tpr_section_div"
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            onkeyup="this.value=numberWithCommas(this.value)"
                                                                            value="{{ isset($quotaCoverreinprop) ? number_format((int) $quotaCoverreinprop->treaty_amount, 2) : '' }}"required
                                                                            disabled>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3 surp_retention_amt_div tpr_section_div"
                                                                        ...
                                                                        @if (isset($quotaCoverreinprop)) hidden @endif>
                                                                        <h6> Surplus </h6>
                                                                        <label class="form-label required">Retention
                                                                            Amount</label>
                                                                        <input type="text"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            onkeyup="this.value=numberWithCommas(this.value)"
                                                                            value="{{ isset($surpCoverreinprop) ? number_format((int) $surpCoverreinprop->retention_amount, 2) : '' }}"required
                                                                            disabled>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-3 no_of_lines_div tpr_section_div"
                                                                        ...
                                                                        <input type="number"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            name="no_of_lines[]"
                                                                            value="{{ isset($surpCoverreinprop) ? number_format((int) $surpCoverreinprop->no_of_lines, 2) : '' }}"required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-3 surp_treaty_limit_div tpr_section_div"
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            onkeyup="this.value=numberWithCommas(this.value)"
                                                                            value="{{ isset($surpCoverreinprop) ? number_format((int) $surpCoverreinprop->treaty_amount, 2) : '' }}"required
                                                                            disabled>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3 estimated_income_div tpr_section_div"
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            onkeyup="this.value=numberWithCommas(this.value)"
                                                                            value="{{ isset($surpCoverreinprop) ? number_format((int) $surpCoverreinprop->estimated_income, 2) : '' }}"
                                                                            required>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-3 cashloss_limit_div tpr_section_div"
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            data-counter="{{ $loop->index }}"
                                                                            onkeyup="this.value=numberWithCommas(this.value)"
                                                                            value="{{ isset($surpCoverreinprop) ? number_format((int) $surpCoverreinprop->cashloss_limit, 2) : '' }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 reinclass_code tnp_section_div">
                                                        ...
                                                        <select class="form-inputs select2 reinclass_code tnp_section"
                                                            ...
                                                            @elseif(
                                                                ...
                                                                @foreach ($reinsclasses as $reinsclass)
                                                                    <option value="{{ $reinsclass->class_code }}"
                                                                        {{ $coverreinpropClasses->pluck('reinclass')->contains($reinsclass->class_code) ? 'selected' : '' }}>
                                                                        {{ $reinsclass->class_name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    ...
                                                    <div class="col-sm-3 method tnp_section_div">
                                                        ...
                                                        <select name="method" id="method"
                                                            ...
                                                            <option value="B"
                                                                {{ $coverReinLayers && $coverReinLayers->pluck('method')->contains('B') ? 'selected' : '' }}>
                                                                Burning
                                                                Cost (B)</option>
                                                            <option value="F"
                                                                {{ $coverReinLayers && $coverReinLayers->pluck('method')->contains('F') ? 'selected' : '' }}>
                                                                Flat
                                                                Rate (F)</option>
                                                        </select>
                                                    </div>
                                                        ...
                                                        <div class="layer-sections"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-2 limit_per_reinclass_div">
                                                                    ...
                                                                    <select class="form-inputs limit_per_reinclass"
                                                                        name="limit_per_reinclass"
                                                                        id="limit_per_reinclass-{{ $loop->index }}-{{ $loop->index }}"
                                                                        required>
                                                                        <option value="">Select Option</option>
                                                                        <option value="N"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-1">
                                                                    <label class="form-label required">Reinclass</label>
                                                                    <input type="hidden" class="form-control layer_no"
                                                                        id="layer_no-{{ $loop->index }}-{{ $loop->index }}"
                                                                        name="layer_no[]" value="1" readonly>
                                                                    <input type="hidden"
                                                                        class="form-control nonprop_reinclass"
                                                                        id="nonprop_reinclass-{{ $loop->index }}-{{ $loop->index }}"
                                                                        name="nonprop_reinclass[]"
                                                                        value="{{ $reinLayer->reinclass }}" readonly>
                                                                    <input type="text"
                                                                        class="form-control nonprop_reinclass_desc"
                                                                        id="nonprop_reinclass_desc-{{ $loop->index }}-{{ $loop->index }}"
                                                                        name="nonprop_reinclass_desc[]"
                                                                        value="{{ isset($reinLayer->class_name) ? $reinLayer->class_name : $reinLayer->reinclass }}"
                                                                        readonly>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-2 indemnity_treaty_limit_div">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-inputs indemnity_treaty_limit"
                                                                        id="indemnity_treaty_limit-{{ $loop->index }}-0{{ $loop->index }}"
                                                                ...
                                                                <div class="col-sm-2 underlying_limit_div tnp_section_div">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-inputs underlying_limit tnp_section"
                                                                        aria-label="underlying_limit"
                                                                        id="underlying_limit-{{ $loop->index }}-{{ $loop->index }}"
                                                                ...
                                                                <div class="col-sm-2 egnpi_div tnp_section_div">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-inputs egnpi tnp_section"
                                                                        aria-label="egnpi"
                                                                        id="egnpi-{{ $loop->index }}-{{ $loop->index }}"
                                                                ...
                                                                <div class="col-sm-3 burning_rate_div tnp_section_div">
                                                                    ...
                                                                    <input type="text" name="min_bc_rate[]"
                                                                        id="min_bc_rate-{{ $loop->index }}-{{ $loop->index }}"
                                                                ...
                                                                <div class="col-sm-2 burning_rate_div tnp_section_div">
                                                                    ...
                                                                    <input type="text" name="max_bc_rate[]"
                                                                        id="max_bc_rate-{{ $loop->index }}-{{ $loop->index }}"
                                                                        class="form-inputs burning_rate tnp_section"
                                                                        value="{{ number_format($reinLayer->max_bc_rate, 2) }}">
                                                                </div>

                                                                <!--For Flat Rate: (%)-->
                                                                @if ($reinLayer->flat_rate > 0)
                                                                    <div class="col-sm-2 flat_rate_div tnp_section_div ">
                                                                        <label class="form-label required">For Flat Rate:
                                                                            (%)</label>
                                                                        <input type="text" name="flat_rate[]"
                                                                            id="flat_rate-{{ $loop->index }}-{{ $loop->index }}"
                                                                            class="form-inputs flat_rate tnp_section"
                                                                            value="{{ number_format($reinLayer->flat_rate, 2) }}"
                                                                            @if ($reinLayer->method == 'B') required readonly @endif>
                                                                    </div>
                                                                @endif
                                                                ...
                                                                <div class="col-sm-3 burning_rate_div tnp_section_div">
                                                                    <label class="form-label required">Upper Adjust.
                                                                        Annually Rate</label>
                                                                    <input type="text" name="upper_adj[]"
                                                                        id="upper_adj-{{ $loop->index }}-{{ $loop->index }}"
                                                                        class="form-inputs burning_rate tnp_section"
                                                                ...
                                                                <div class="col-sm-3 burning_rate_div tnp_section_div">
                                                                    <label class="form-label required">Lower Adjust.
                                                                        Annually Rate</label>
                                                                    <input type="text" name="lower_adj[]"
                                                                        id="lower_adj-{{ $loop->index }}-{{ $loop->index }}"
                                                                        class="form-inputs burning_rate tnp_section"
                                                                ...
                                                                <div class="col-sm-3 min_deposit_div tnp_section_div">
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        <input type="text" name="min_deposit[]"
                                                                            id="min_deposit-{{ $loop->index }}-{{ $loop->index }}"
                                                                            class="form-control min_deposit tnp_section"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        <input type="text" name="reinstatement_value[]"
                                                                            id="reinstatement_value-{{ $loop->index }}-{{ $loop->index }}"
                                                                            class="form-control reinstatement_value tnp_section"
                    ...
                    <div class="mt-3" style="float:right">
                        <button type="button" name="previous" class="btn btn-outline-danger" id="cancel">
                        ...
                        @if (!is_null($prospect))
                            <button type="button" class="btn btn-outline-primary" data-prospect="" id="sales_mngt">
                                <span class="fa fa-arrow-right"></span> Submit to Sales
                            </button>
                            <button style="display:none" type="button" class="btn btn-outline-primary" data-prospect=""
                                id="process_pq">
        ...
        <div class="modal-dialog modal-lg" role="document" style="min-width:70%">
            <div class="modal-content">
                ...
                <div class="Xcontainer">
                    <div class="modal-body">
                        <form action="{{ route('update.opp.status') }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("select#type_of_bus").change(function() {
                ...
                let selectedTreatyType = @json(isset($prospProperties->treaty_code) ? $prospProperties->treaty_code : '');
                $.ajax({

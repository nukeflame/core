@props(['cover', 'typeOfBus', 'customer', 'summaryData'])

<div class="card border-0 shadow-sm mb-3">
    <div class="card-header bg-white border-0 pb-2 px-0 pt-2">
        <h6 class="mb-0 fw-semibold">
            <i class="ri-information-line me-2" style="vertical-align: -2px;"></i>Cover Summary
        </h6>
    </div>
            ...
            <div class="col-md-6">
                <div class="summary-items">
                    ...
                    <div class="summary-item">
                        ...
                        <span class="summary-value text-uppercase">{{ $cover->transaction_type }}</span>
                    </div>
                    ...
                    @if (in_array($cover->type_of_bus, ['FPR', 'FNP']))
                        ...
                        <div class="summary-item">
                            ...
                            <span class="summary-value text-success fw-bold">
                                {{ number_format($cover->rein_premium, 2) }}
                            </span>
                        </div>
                        ...
                        <div class="summary-item mt-1 pt-2">
                            ...
                            <div>
                                ...
                                <small class="text-muted">
                                    {{ number_format(($cover->share_offered / 100) * $cover->rein_premium, 2) }}
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="summary-item">
                            ...
                            <div>
                                <span class="summary-value d-block">
                                    {{ number_format($cover->rein_comm_rate, 2) }}%
                                </span>
                                <small class="text-muted">
                                    {{ number_format($cover->rein_comm_amount, 2) }}
                                </small>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="summary-items">
                    <div class="summary-item">
                        ...
                        <span class="summary-value">{{ $typeOfBus->bus_type_name }}</span>
                    </div>
                    ...
                    @if (in_array($cover->type_of_bus, ['FPR', 'FNP']))
                        ...
                        <div class="summary-item mt-2 pt-2">
                            ...
                            <div>
                                <span class="summary-value d-block">
                                    {{ number_format($cover->brokerage_comm_rate, 2) }}%
                                </span>
                                <small class="text-muted">
                                    {{ number_format($cover->brokerage_comm_amt, 2) }}
                                </small>
                            </div>
                        </div>

...
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div style="border: solid 1px #DDD; border-radius: 5px; padding-left: 5px;">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <input type="text" name="commentary" value="{{ $document_dict->document_description }}"  class="form-control">
                            </td>
                        </tr>
                        ...
                        @if($eft_no != null)
                            <tr id="eft_no">
                                <td>EFT No</td>
                                <td colspan="2">
                                    <input type="text" name="eft_no" value="{{ $eft_no }}" id="eft_no"  class="form-control" readonly>
                                </td>
                            </tr>
                        @endif
                ...
                <div id="view-link" class="mt-3 p-4 text-center" style="height: 300;width:100%;border: 1px solid #DDD;">
                    <a href="{{ route('view.largefile',$document_dict->document_id) }}" id="preview_btn" role="button" class="btn btn-primary">File too Large Click here to Open</a>
                </div>
                @else
                    <object data="data:{{$file_type}};base64,{{ $base64_encoded_string }}" type=""  height="600" width="100%" style="border: solid 1px #DDD;"></object>
                @endif
                <p class="mt-3">&nbsp;</p>
                ...
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea rows="10" columns="20" type="text" name="comment" id="comment" class="form-control" required> </textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="alert_user">Send To</label>
                            <select name="alert_user[]" id="alert_user" class="form-control multiple-select" multiple>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-editcomment" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg"  role="document">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="required">Comment</label>
                            <textarea rows="10" columns="20" type="text" name="comment" id="edcomment" class="form-control" required> </textarea>
                        </div>

                        <div class="col-md-6">
                            <label for="alert_user">Send To</label>
                            <select name="alert_user[]" id="edalert_user" class="form-control multiple-select" multiple>
                                <option value="">Select User</option>
                                @foreach($aimsusers as $aimsuser)
                                    <option value="{{ $aimsuser->user_id }}">{{ $aimsuser->name }} </option>
                                @endforeach
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-approvedocument" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg"  role="document">
            <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                ...
                {{ csrf_field() }}
                    <input type="hidden" name="document_id" value="{{ $document_dict->document_id }}" id="document_id">
                    <div class="row">
                        <div class="col-md-9">
        ...
        $(document).ready(function(){
            ...
            $('#comments-table').on('click','tr #edit_process',function(e){
                ...
                if (comment_id) {
                    ...
                    toastr.error("No comment unique id was generated initially. This action can only be done on comments added now and hence forth.")
                }

                    ...
                    <div class="card-body pb-0">
                        <div class="row row-cols-12 mb-2">
                            ...
                            <div class="col-sm-3 fac_section_div">
                                ...
                                <div id="insured_name_results" class="dropdown-menu" style="display: none;"></div>
                        ...
                        <div class="row row-cols-12 mb-2">
                            <x-OnboardingInputDiv id="industry_div" class="new_pros">
                                <x-SearchableSelect name="industry" id="industry" req="required" inputLabel="Industry">
                        ...
                        <div class="row row-cols-12 mb-2">
                            <div class="col-xl-3 fac_section_div brokerage_comm_rate_amt_div">
                                <label class="form-label" id="brokerage_comm_rate_amount_label">Brokerage Rate
                                    Amount</label>
                                <input type="text" class="form-inputs fac_section amount" id="brokerage_comm_rate_amt"
                                    name="brokerage_comm_amt" value="0" readonly>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <x-OnboardingInputDiv id="date_effective_div">
                                <x-DateInput name="effective_date" id="effective_date"
                                    placeholder="Enter cover start date" inputLabel="Cover Start Date" req="" />
                            </x-OnboardingInputDiv>
                            <x-OnboardingInputDiv id="date_closing_div">
                                <x-DateInput name="closing_date" id="closing_date" placeholder="Enter bid closing date"
                                    inputLabel="Cover End  Date" req="" />
                            </x-OnboardingInputDiv>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_rein_class').on('click', function() {
                ...
                const currentSectionLabel = String.fromCharCode(65 + counter);
            ...
            $('#effective_date').on('change', function() {
                ...
                if (effectiveDate) {
                    ...
                    var closingDate = date.toISOString().split('T')[0];

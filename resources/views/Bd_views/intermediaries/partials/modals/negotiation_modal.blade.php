...
{{-- @push('script')
    <script>
        $(document).ready(function() {
            ...
            const $negotiationForm = $("#negotiationForm");
            const $negotiationModal = $("#negotiationModal");
            ...
            $negotiationModal.on("shown.bs.modal", function() {
                $negotiationForm.find(".is-invalid").removeClass("is-invalid");
                $negotiationForm.find(".invalid-feedback").remove();
                $negotiationForm.find(".reinsurer-validation-error").remove();
            });
            ...
            $negotiationModal.on("click", "button[data-bs-dismiss='modal']", function() {
                resetProposalModal();
            });
            ...
            function validateProposalForm() {
                ...
                $negotiationForm.find(".form-inputs").each(function() {
                ...
                const requiredFiles = $negotiationForm.find('input[type="file"][required]');
                const missingFiles = [];
            ...
            function displayValidationErrors(errors) {
                ...
                const $firstError = $negotiationForm.find(".is-invalid").first();
            ...
            function submitNegotiationForm() {
                const $submitBtn = $negotiationForm.find("button[type='submit']");
                ...
                $.ajax({
                    url: $negotiationForm.attr("action"),
                    method: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            function prepareFormData() {
                ...
                $negotiationForm.find("input:not([type='file']), select, textarea").each(function() {
                    const $element = $(this);
                ...
                $negotiationForm.find("input[type='file']").each(function() {
                    const $fileInput = $(this);
        ...
        `;
            ...
            function resetProposalModal() {
                ...
                $negotiationForm.find(".is-invalid").removeClass("is-invalid");
                $negotiationForm.find(".is-v").removeClass("is-v");
                $negotiationForm.find(".invalid-feedback").remove();
                $negotiationForm.find(".reinsurer-validation-error").remove();
            ...
            class BreakdownEditor {
                ...
                saveChanges() {
                    ...
                    $.ajax({
                        url: $negotiationForm.attr("action") || "/opportunities/update",
                        method: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,

...
<div id="lostModal" class="modal fade effect-scale md-wrapper" tabindex="-1" data-bs-backdrop="static"
...
<!-- Lost Stage Modal -->
<div id="lsostModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title">❌ Deal Lost - Analysis</h3>
        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select class="form-control">
                        <option>Pricing - Too High</option>
                        <option>Coverage Terms</option>
                        <option>Competitor Won</option>
                        <option>Client Budget Constraints</option>
                        <option>Risk Appetite Mismatch</option>
                        <option>Timing Issues</option>
                        <option>Internal Decision</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                <label class="form-label">Competing Insurer/Broker</label>
                <input type="text" class="form-control" placeholder="Enter competitor name if known" />
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label">Competitor's Premium (KES)</label>
                    <input type="number" class="form-control" placeholder="If known" step="0.01" />
                </div>
                <div class="form-group">
                    <label class="form-label">Our Final Quote (KES)</label>
                    <input type="number" class="form-control" value="5900000" step="0.01" readonly />
                </div>
            </div>
            <div class="form-group">
                <label class="form-label">Client Feedback</label>
                <textarea class="form-control" rows="3"
                    placeholder="Record client's reasons for not proceeding, feedback on our proposal..."></textarea>
            </div>
            <div class="form-group">
                <label class="form-label">Lessons Learned</label>
                <textarea class="form-control" rows="3"
                    placeholder="What could we have done differently? Process improvements for future deals..."></textarea>
            </div>
            <div class="form-group">
                <label class="form-label">Future Opportunity</label>
                <select class="form-control">
                    <option>Renewal Opportunity Next Year</option>
                    <option>Other Lines of Business</option>
                    <option>Subsidiary Companies</option>
                    <option>No Future Opportunity</option>
                    <option>Client Relationship Maintained</option>
                </select>
            </div>
        </div>
        <div class="modal-actions">
            <button class="btn btn-secondary" onclick="closeModal('lostModal')">
                Cancel
            </button>
            <button class="btn btn-primary" onclick="updateStage('lost')">
                Mark as Lost
            </button>
        </div>
    </div>

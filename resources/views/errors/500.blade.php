...
<head>
    ...
    <title>@yield('title', __('Server Error'))</title>
    <!-- Styles -->
    <style>
        html,
        body {
...
<body>
    <div class="flex-center full-height">
        <div class="content">
            <div class="code" role="heading" aria-level="1" aria-label="Error code: @yield('code', '500')">
                @yield('code', '500')
            </div>
            ...
            <div class="title">@yield('title', 'Internal Server Error')</div>
            <div class="subtitle">@yield('message', 'Oops! Something went wrong on our servers.')</div>

            <div class="message">
                @yield('description', 'We\'re experiencing some technical difficulties. Our team has been notified and is working to fix the issue as soon as possible.')
            </div>

@extends('layouts.app', [
    'pageTitle' => 'Create Budget Income - ' . $company->company_name,
])

@section('content')
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Add Budget Income Records</h1>
    ...
    <div class="card custom-card">
        <div class="card-header">
            <div class="card-title">New Budget Income Entry</div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.budget_allocation.incomes_store') }}" method="POST" id="budgetIncomeForm">
                @csrf
                <div class="row mb-4">
                    <div class="col-md-3">
                ...
                <div class="card mb-4">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                        <h6 class="mb-0">Income Statement Items</h6>
                    ...
                    <div class="card-body">
                        <div id="incomeItemsContainer">
                            <div class="row mb-3 income-item">
                                <div class="col-md-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            `;
                ...
                $('#incomeItemsContainer').append(newItem);
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            toastr.success('Budget income records saved successfully');
                            setTimeout(() => {

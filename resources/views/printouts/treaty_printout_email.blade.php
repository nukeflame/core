...
@section('content')
    ...
    @if ((isset($stage) && $stage == 3) || $stage == 4)
        <div class="main-content">
            ...
            <div class="content-row">
                ...
                <div class="content-cell">
                    {{ $opportunity->effective_date . ' To ' . $opportunity->closing_date }}
                </div>
            </div>
            <div class="footer">
            ...
            @php
                ...
                if (!empty($orderedQuoteSchedules)) {
                    foreach ($orderedQuoteSchedules as $item) {
                        if (property_exists($item, 'current') && !empty($item->current)) {
                            $hasCurrent = true;
                        }
                        if (property_exists($item, 'proposed') && !empty($item->proposed)) {
                            $hasProposed = true;
                        }
                        if (property_exists($item, 'final') && !empty($item->final)) {
                            $hasFinal = true;
                        }
                    }
                }

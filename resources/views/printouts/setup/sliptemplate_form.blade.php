...
@section('content')
    <div>
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">New Clause</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li clalss="breadcrumb-item"><a href="javascript:void(0);">{{ $classcode->class_name }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">New Clause</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="cover-wrapper form-group">
            <form id="register_clause"
                action="{{ !empty($clauses) ? route('docs-setup.edit-clause') : route('docs-setup.save-clause') }}"
                method="POST">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="row row-cols-12">
                        <div class="col-md-6">
                            <label class="form-label required">Clause Title</label>
                                ...
                                <select class="form-inputs section select2" name="type_of_bus" id="type_of_bus">
                                    ...
                                    @foreach ($types_of_bus as $type_of_bus)
                                        <option value="{{ $type_of_bus->bus_type_id }}"
                                            {{ $clauses?->type_of_bus == $type_of_bus->bus_type_id ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <button type="button" id="save_cluse"
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            $("form #save_cluse").on('click', function(e) {
                e.preventDefault()
                ...
                if ($("form#register_clause").valid()) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            toastr.success("Clause saved successfully");
                        } else {
                            return false;
                        }
                    });

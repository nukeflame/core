...
@section('content')
    <div>
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Cover Slip Template</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Printouts Setup</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Cover Slip</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-6">
                <button type="button" class="btn btn-sm btn-dark btn-wave" id="newSlipClause">Add new Clause</button>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title">Clause list</div>
                    </div>
                    <div class="card-body">
        ...
        <div class="modal effect-scale" id="newSlipModal" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form id="editSlipform" action="{{ route('docs-setup.sliptemplate_form') }}">
                        @csrf
                    ...
                    <form id="newSlipform" action="{{ route('docs-setup.sliptemplate_form') }}">
                        @csrf
                        <div class="modal-body">
                            <h6 class="form-label md-title font-weight-bold mb-2">Create Clause</h6>
                            <div class="row">
                                <div class="col">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#coversliplist').DataTable({
                ...
                ajax: {
                    url: '{{ route('docs-setup.coverslip_datatable') }}',
                },
                columns: [{
                        data: 'clause_id',
                ...
                if ($(this).val() != '') {
                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            $('#sel_classcode').empty();
                            var classes = resp.classes;
                            $('#sel_classcode').append($('<option>').text('-- Select --').attr(
                                'value', ''));

                            $.each(classes, function(i, value) {
                                $('#sel_classcode').append($('<option>').text(value
                                    .class_code + " - " +
                                    value.class_name).attr('value', value
                                    .class_code));
                            });
                        },
                        error: function(resp) {
            ...
            $(document).on('click', '.remove-clause', function() {
                ...
                swal.fire({
                    ...
                    fetchWithCsrf("{!! route('docs-setup.delete-clause') !!}", {
                            method: 'POST',
                            headers: {

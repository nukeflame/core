            ...
            <tr>
                <td>
                    <table class="w-100 courier-10 p-0 m-0 reinsurer-details">
                        ...
                        <tr>
                            <td> {{ $cover->customer->street }}, {{ $cover->customer->city }} </td>
                        </tr>
                        <tr>
                            <td> {{ \App\Models\Country::where('country_iso', $cover->customer->country_iso)->value('country_name') }}
                            </td>
                        </tr>
                        <tr>
                ...
                <td valign="top">
                    <table class="w-100">
                        ...
                        <tr>
                            ...
                            <td class="pt-4 courier-9">{{ formatDate($claim->date_notified_reinsurer) }}</td>
                        </tr>
                        <tr>
        ...
        <table id="particular-details" style="margin-bottom: 10px; font-size: 8pt;">
            ...
            <tr>
                ...
                <td class="calibri-10 text-left p-8 bottom-border">
                    {{ number_format($totalClaimAmount, 2) }} @ {{ number_format($cover->share_offered, 2) }}%
                </td>

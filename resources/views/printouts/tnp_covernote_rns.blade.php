...
<table style="width:100%; margin:0px; border:3px; padding:3px;">
    ...
    <tr>
            ...
            <td align="left" style="font-size: 9.0pt; font-family: 'Aptos Mono'; border: 1px solid #181212; padding: 8px;">{{number_format($coverpremium->basic_amount,2) }}@if($coverpremium->apply_rate_flag=='Y' && $coverpremium->rate !=0) @ {{number_format($coverpremium->rate,2)}}% @endif
            </td>
            <td align="left" style="font-size: 9.0pt; font-family: 'Aptos Mono'; border: 1px solid #181212; padding: 8px;">{{number_format($coverpremium->basic_amount,2) }}
            </td>
...
<br/>
    ...
    <table style="width:100%; border: 1px solid #181212; padding: 8px;">
        <tr >
            <td  align="left"   colspan="2" style="font-size: 9.0pt; font-family: 'Aptos Mono'; border: 1px solid #181212; padding: 8px; font-weight: bold;">BALANCE DUE FROM YOU</td>
            
            <td align="right" style="font-size: 9.0pt; font-family: 'Aptos Mono'; border: 1px solid #181212; padding: 8px; font-weight: bold;">{{ number_format($debit->net_amt,2) }}</td>
        </tr>
    </table>

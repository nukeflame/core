...
.courier-9{font-size: 9.0pt; font-family: 'Aptos', sans-serif;}
.courier-10{font-size: 10.0pt; font-family: 'Aptos', sans-serif;}
.w-100{width: 100%;}
...
<div class="reinsurer-page  {{ $index === 0 ? 'first-page' : '' }}" style="width:100%;margin-top: 100px;padding:0px; font-size: 10.0pt; font-family: 'Aptos', sans-serif;">

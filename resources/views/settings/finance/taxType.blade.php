...
<div class="container">
    ...
    <button type="button" class="btn btn-primary btn-sm custom-btn" data-bs-toggle="modal" data-bs-target="#taxType" style="background-color: #231747;  color: white;"><i class='bx bx-plus'></i> Add taxType </button>
...
<div class="modal fade" id="taxType" tabindex="-1" aria-labelledby="taxType" data-bs-keyboard="false" aria-hidden="true">
                ...
                <form id="store_taxType" action="{{ route('taxType.store') }}" method="post">
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="Tax Description" aria-label="Tax Description" id="type_description" name="type_description">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="TransType" aria-label="TransType" id="transtype" name="transtype">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">BASIS</label>
                            <input type="text" class="form-control" placeholder="BASIS" aria-label="BASIS" id="BASIS" name="BASIS">
                        </div>
                        <div class="col-md-6">
...
<div class="modal fade" id="edit_taxTypeModal" tabindex="-1" aria-labelledby="edit_taxTypeModal" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="edit_taxType" action="{{ route('taxType.edit') }}" method="post">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Tax Description</label>
                            <input type="text" class="form-control" placeholder="Tax Description" aria-label="Tax Description" id="ed_type_description" name="ed_type_description">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Control Account</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">TransType</label>
                            <input type="text" class="form-control" placeholder="TransType" aria-label="TransType" id="ed_transtype" name="ed_transtype">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">BASIS</label>
                            <input type="text" class="form-control" placeholder="BASIS" aria-label="BASIS" id="ed_BASIS" name="ed_BASIS">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Tax Code</label>

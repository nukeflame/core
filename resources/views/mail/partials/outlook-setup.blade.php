...
<div class="modal fade effect-flip-vertical modal-overlay" id="outlook-setup-modal" data-bs-backdrop="static"
...
<div class="modal fade modal-overlay" id="outlook-connection-modal" tabindex="-1" data-bs-backdrop="static">
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            // Connect to Outlook
            $('#connectOutlookAccount').on('click', function() {
                connectToOutlook();
            });

            // Skip setup
            $('#skipOutlookSetup').on('click', function() {
            ...
            function connectToOutlook() {
                var $connectBtn = $('#connectOutlookAccount');
                var $spinner = $connectBtn.find('.spinner-border');
                ...
                $.ajax({
                        url: '{{ route('mail.outlook.connect') }}',
                        method: 'POST',
                        headers: {
            ...
            function hideAllSteps() {
                $('.connection-step').addClass('d-none');
            }
